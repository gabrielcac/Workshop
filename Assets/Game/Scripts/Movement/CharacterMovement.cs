...
{
	/// <summary>
	/// Além de movimentar o personagem, este script o rotaciona para que ele olhe na direção em que está indo,
	/// e avisa ao <see cref="Animator"/> para que toque a animação de andar enquanto o personagem se move.
	/// </summary>
